...
parser.add_argument('--experiment_dir', required=True,
                    help='experiment1 directory, data, samples,checkpoints,etc')
...
parser.add_argument('--obj_path', type=str, default='./experiment1/data/val.obj', help='the obj file you infer1')
...
def main():
    ...
    if args.from_txt:
        src = args.src_txt
        # src = read_txt("./charset/hanziziku1.txt")
